...
public class SectionSetBlockRenderView implements BlockRenderView {
    ...
    private final Map<ChunkSectionPos, ReadableContainer<BlockState>> blockStateContainer;
    private final BlockRenderView base;

    public SectionSetBlockRenderView(Map<ChunkSectionPos, ReadableContainer<BlockState>> blockStateContainer, BlockRenderView base) {
