...
/**
 * Contains a "snapshot" of a world at a given time without copying the entire world.
 */
public class WorldSnapshot implements ChunkView {

    /**
     * The underlying world that this is a view of. Note that the world may have changed since the snapshot was taken.
     */
    @Getter
